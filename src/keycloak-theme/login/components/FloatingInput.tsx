...
export function FloatingInput({id, className, name, type, label, autoFocus, autoComplete}: Props) {
    return (
      <div className={twMerge("tw-relative tw-h-11 tw-w-full", className)}>
        ...
        />
        <label htmlFor={id} className="after:content[' '] tw-pointer-events-none tw-absolute tw-left-0 tw-top-[-0.375rem] tw-flex tw-h-full 
